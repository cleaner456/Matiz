...
import roxy.music.app.canvas.MatizCanvas
import roxy.music.app.canvas.CanvasArtwork
...
import roxy.music.app.constants.MaxCanvasCacheSizeKey
...
fun Thumbnail(
    ...
    val MatizCanvasEnabled by rememberPreference(MatizCanvasKey, false)
