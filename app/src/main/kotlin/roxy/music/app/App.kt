...
import roxy.music.app.constants.*
import roxy.music.app.extensions.*
import roxy.music.app.ui.screens.settings.ThemePalettes
import roxy.music.app.ui.theme.ThemeSeedPalette
import roxy.music.app.ui.theme.ThemeSeedPaletteCodec
...
import roxy.music.app.utils.clearPlaybackAuthSession
...
import roxy.music.app.ui.player.CanvasArtworkPlaybackCache
...
import roxy.music.app.utils.toPlaybackAuthState
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        Timber.plant(Timber.DebugTree())
        try {
            Timber.plant(roxy.music.app.utils.GlobalLogTree())
        } catch (_: Exception) {}
