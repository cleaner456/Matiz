...
import roxy.music.app.App
import roxy.music.app.constants.GitHubReleasesEtagKey
import roxy.music.app.constants.GitHubReleasesFingerprintKey
import roxy.music.app.constants.GitHubReleasesJsonKey
import roxy.music.app.constants.GitHubReleasesLastCheckedAtKey
...
object Updater {
    ...
    private suspend fun fetchReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/RoxyBasicNeedBot/Matiz/releases?per_page=$perPage") {
                headers {
    ...
    suspend fun getCommitHistory(count: Int = 20, branch: String = "dev"): Result<List<GitCommit>> =
        runCatching {
            val response =
                client.get("https://api.github.com/repos/RoxyBasicNeedBot/Matiz/commits?sha=$branch&per_page=$count")
                    .bodyAsText()
    ...
    fun getLatestDownloadUrl(): String {
        val baseUrl = "https://github.com/RoxyBasicNeedBot/Matiz/releases/latest/download/"
